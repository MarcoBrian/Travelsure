        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-pretty text-base md:text-lg text-muted-foreground">
              Travelsure uses smart contracts and real‑time oracles to verify delays and pay claims instantly. No
              paperwork. No waiting. Fully transparent coverage on the blockchain.
            </p>
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                Non‑custodial, audited contracts
              </li>
              <li className="flex items-center gap-2">
                <span className="h-2.5 w-2.5 rounded-full bg-primary/50" />
          ...
          <div className="relative rounded-xl border bg-card p-6 md:p-8">
            <div className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">Sample policy</p>
                <h3 className="text-lg font-medium">NYC → SF • Tonight 19:45</h3>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-lg border p-3">
                  <p className="text-xs text-muted-foreground">Premium</p>
                  <p className="mt-1 text-xl font-semibold">10 USDC</p>
                </div>
                <div className="rounded-lg border p-3">
                  <p className="text-xs text-muted-foreground">Payout</p>
                  <p className="mt-1 text-xl font-semibold text-primary">200 USDC</p>
                </div>
              </div>
              <div className="rounded-lg border p-3">
                <p className="text-xs text-muted-foreground">Status</p>
                <p className="mt-1 font-medium">Auto‑pay on delay -&gt; instant</p>
              </div>
